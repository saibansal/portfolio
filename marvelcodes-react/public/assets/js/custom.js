...
$(document).ready(function () { 
  ...
  $('.logo').removeClass('openlogo');
		...
		$(document).on("click", ".home-page, .about, .portfolio, .contact", function(){
	...
	$(document).on('click', '.homepage__item .portfolio', function	(){
		$('.site-header__top nav ul li.portfolio').addClass('active').prevAll().removeClass('active').prevAll().removeClass('active');
	});
 
	$(document).on('click', '.homepage__item .about', function	(){
		$('.site-header__top nav ul li.about').addClass('active').prevAll().removeClass('active').prevAll().removeClass('active');
	});
	
		$(document).on('click', '.homepage__item .contact', function	(){
		$('.site-header__top nav ul li.contact').addClass('active').prevAll().removeClass('active').prevAll().removeClass('active');
	});
  ...
  if ($(window).width() > 1200) {
	...
	$(document).on("click", ".portfolio-items", function(){
